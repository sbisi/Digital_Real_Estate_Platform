...
#                   name='pg2',  # name of page, commonly used as name of link
#                   title='Tips'  # epresents the title of browser's tab
#)


dash.register_page(__name__, name='Value Chain')
...
layout = html.Div(
    [
        dcc.Markdown('## Value Chain Coming soon!', style={'textAlign':'center'})
#        dbc.Row([
#            dbc.Col(
#                [
